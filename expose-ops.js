...
export function buildOpsExpose() {
    return {
        ...
        woRequestOnHandBasis:            store.woRequestOnHandBasis,
        woRequestOnHandToneClass:        store.woRequestOnHandToneClass,
        woRequestOnHandSubLabel:         store.woRequestOnHandSubLabel,
        woRequestDataGridClass:          store.woRequestDataGridClass,
        woRequestOnHandFormula:          store.woRequestOnHandFormula,
        woRequestEstQtyInStockFormula:     store.woRequestEstQtyInStockFormula,
        woRequestEstQtyInStockFormula36mo: store.woRequestEstQtyInStockFormula36mo,
        woRequestOnOrder:                store.woRequestOnOrder,
        woRequestOnOrderParents:         store.woRequestOnOrderParents,
        woRequestOnOrderLoading:         store.woRequestOnOrderLoading,
        woRequestOnOrderTotal:           store.woRequestOnOrderTotal,
        woRequestWip:                    store.woRequestWip,
        woRequestWipLoading:             store.woRequestWipLoading,
        woRequestWipHasAny:              store.woRequestWipHasAny,
        woRequestPipelineQty:            store.woRequestPipelineQty,
        ...
        purchasingCarriedNote:          store.purchasingCarriedNote,
